...
- **Particles example:** orbital dynamics (stable orbits), periodic FPS counter, soft boundary reflection
- **Dependencies:** wgpu v0.24.2 → v0.24.3 (GLES X11 display use-after-close fix)
