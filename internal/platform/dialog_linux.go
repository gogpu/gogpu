...
// xdg-desktop-portal D-Bus client
//
// Minimal hand-written D-Bus client covering exactly the wire shapes needed by
// org.freedesktop.portal.FileChooser.  No external dependencies — consistent
// with the project's zero-dependency policy (ADR-XX).
//
// Wire format summary:
